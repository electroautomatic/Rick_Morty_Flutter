...
/// @nodoc
abstract class _$$_ResulstCopyWith<$Res> implements $ResultsCopyWith<$Res> {
  factory _$$_ResulstCopyWith(
          _$_Resulst value, $Res Function(_$_Resulst) then) =
      __$$_ResulstCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$_ResulstCopyWithImpl<$Res>
    extends _$ResultsCopyWithImpl<$Res, _$_Resulst>
    implements _$$_ResulstCopyWith<$Res> {
  __$$_ResulstCopyWithImpl(_$_Resulst _value, $Res Function(_$_Resulst) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_Resulst with DiagnosticableTreeMixin implements _Resulst {
  const _$_Resulst(
      {required this.id,
      required this.name,
  ...
  factory _$_Resulst.fromJson(Map<String, dynamic> json) =>
      _$$_ResulstFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ResulstCopyWith<_$_Resulst> get copyWith =>
      __$$_ResulstCopyWithImpl<_$_Resulst>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ResulstToJson(
      this,
    );
  }
}

abstract class _Resulst implements Results {
  const factory _Resulst(
      ...
      required final String image}) = _$_Resulst;

  factory _Resulst.fromJson(Map<String, dynamic> json) = _$_Resulst.fromJson;
